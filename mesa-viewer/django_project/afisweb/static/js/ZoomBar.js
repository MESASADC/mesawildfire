 ...
 */
OpenLayers.Control.ZoomBar = OpenLayers.Class(OpenLayers.Control.PanZoom, {
    ...
    */
    draw: function(px) {
        ...
        this._addButton("zoomin", "zoom-plus-mini.png", centered.add(0, 0), sz);
    ...
    */
    _addZoomBar:function(centered) {
        ...
        var id = "OpenLayers_Control_ZoomBar_Slider" + this.map.id;
        ...
        if (OpenLayers.Util.alphaHack()) {
            var id = "OpenLayers_Control_ZoomBar" + this.map.id;
