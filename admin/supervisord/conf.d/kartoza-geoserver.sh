...
# Start Geoserver:
docker run --name supervisor_geoserver --link supervisor_postgis:postgis -a stdout -a stderr --rm -v $MESA_ROOT/volumes/geoserver:/opt/geoserver/data_dir -p 58080:8080 kartoza/geoserver
RESULT=$?
