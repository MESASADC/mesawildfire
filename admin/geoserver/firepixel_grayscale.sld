         ...
         <sld:FeatureTypeStyle>
            ...
            <sld:Rule>
               ...
               <sld:PolygonSymbolizer>
                  ...
                  <sld:Fill>
                     <sld:CssParameter name="fill">#b9b8b8</sld:CssParameter>
                  </sld:Fill>
               </sld:PolygonSymbolizer>
            </sld:Rule>
            <sld:Rule>
               ...
               <sld:PolygonSymbolizer>
                  ...
                  <sld:Fill>
                     <sld:CssParameter name="fill">#a2a1a1</sld:CssParameter>
                  </sld:Fill>
               </sld:PolygonSymbolizer>
            </sld:Rule>
            <sld:Rule>
               ...
               <sld:PolygonSymbolizer>
                  ...
                  <sld:Fill>
                     <sld:CssParameter name="fill">#8b8a8a</sld:CssParameter>
                  </sld:Fill>
               </sld:PolygonSymbolizer>
            </sld:Rule>
            <sld:Rule>
